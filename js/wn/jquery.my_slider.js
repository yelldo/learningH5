/**
 * Created by ludynice on 2017/4/9.
 */
jQuery.fn.extend({
    my_slider: function (a) {
        function s() {
            var a;
            switch (j) {
                case"top":
        ...
        var q, r, b = $(this).eq(0), c = $(this).find("ul").eq(0), d = c.find("li"),
            e = $(this).find("ol").eq(0).find("li"), f = b.find("img"), g = f.length, a = a || {},
            h = a.width || t().width, i = a.height || t().height, j = a.deriction || "", k = a.classSelector + "_" + j,
